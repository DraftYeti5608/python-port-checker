...
# Try to open a socket connected to the given port
# and host.
...
def main(argv):
	...
	host = ""
	if len(argv) <=0:
		print("No arguments given! -h/--help for list")
		sys.exit(-1)
	try:
		opts, args = getopt.getopt(argv,"hu:p:s:e:t:",["help=","host=","port=", "rangestart=", "rangeend=", "timeout="])
